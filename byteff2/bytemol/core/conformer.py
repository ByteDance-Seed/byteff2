...
from ase.io.extxyz import key_val_str_to_dict as ase_properties_parser, write_extxyz
...
def write_conformers_to_extxyz(
    conformers: List[Conformer], filename: str, append: bool = False, confkeys: List[str] = None
):
