...
from byteff2.bytemol.core.conformer import (
    Conformer,
    is_charge_key,
    is_energy_key,
    is_force_key,
...
class Molecule:
    def __init__(
        ...
        **kwargs,
        ...
        assert self._aromaticity in ["rdkit", "mdl"], (
    ...
    def _finish(self, **kwargs):
        ...
        assert (
            ...
            == len(self._atomic_masses)
            == len(self._atomic_symbols)
            == len(self._formal_charges)
    ...
    def get_mapped_smiles(
        self, smarts_atoms: Union[Dict, Iterable[int]] = None, *, isomeric: bool = True, kekulize: bool = False
    ) -> str:
...
def read_molecules_from_sdf(
    sdf_file: str, skip_error: bool = True, check_chiral: bool = False, keep_mol_prop: bool = False
) -> Dict[str, Molecule]:
