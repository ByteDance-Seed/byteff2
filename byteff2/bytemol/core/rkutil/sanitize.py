...
from byteff2.bytemol.core.rkutil.information import show_debug_info
...
def normalize_rkmol(rkmol: Chem.Mol) -> Chem.Mol:
    ...
    In our pipeline, -N(=O)=O will be rejected because of sanitization error during initialization, either from sdf
    or from smiles.
...
def sanitize_rkmol(
    rkmol: Chem.Mol, *, aromaticity: str = "rdkit", debug: bool = False, allow_advanced_skip_kekulize: bool = False
) -> Chem.Mol:
