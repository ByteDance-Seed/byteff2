...
def kJ_mol_to_RT(temperature):
    return 1000.0 / (R * temperature)


def RT_to_kJ_mol(temperature):
    return (R * temperature) / 1000.0


def RT_to_kcal_mol(temperature):
    return (R * temperature) / (1000.0 * (kcal / kJ))
...
# ========== Angle Cth / Dihedral K =============

kcal_mol_rad2_to_kJ_mol_rad2 = kcal_mol_to_kJ_mol
kJ_mol_rad2_to_kcal_mol_rad2 = kJ_mol_to_kcal_mol
