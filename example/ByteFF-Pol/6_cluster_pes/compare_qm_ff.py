...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--md_samples_dir", type=str, default="./data/md_sample_examples", help="path to the sampled clusters"
    )
    parser.add_argument("--save_dir", type=str, default="./cluster_pes", help="path to the sampled clusters")
