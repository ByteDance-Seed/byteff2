...
parser.add_argument("--max_dist", type=float, default=10.0, help="maximum displacement in Angstrom")
...
def perturb_coords(coords1: np.ndarray, coords2: np.ndarray, nconfs=100, min_dist=1.5, max_dist=10.0):
