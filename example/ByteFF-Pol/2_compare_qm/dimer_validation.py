...
from byteff2.data import collate_data, IMDataset
...
if __name__ == "__main__":
    ...
    model = load_pretrained_model("ByteFF-Pol-25", device=device)

    dataset_path = get_asset_path("ByteFF-Pol-25/data/validation/dataset_config.yaml")
